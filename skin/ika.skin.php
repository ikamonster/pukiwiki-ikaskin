...
<?php
echo "<style>html,legend{color:#000}#body,p{overflow:visible}#body,main p{display:block}#contents,html{overflow-wrap:break-word}#contents,code,pre{word-wrap:break-word}#_Skin_Article_,pre{width:100%;min-width:0}#header,#page_title,img{vertical-align:middle}#contents,#header,#menubar,#note,#rightbar{word-break:break-all}.note_super,a{text-decoration:none}#contents,#footer,#header,#header>*,body{display:flex}table,tbody,td,th,thead{border-spacing:0;position:relative}html,table{line-height:var(--line-height)}caption,table,th{text-align:left}#_Skin_SkipLink_,#contents,#logo,body,html,pre,svg{height:auto}:root{--mode-width:0;--font-body:sans-serif;--font-headline:var(--font-body);--font-size:100%;--line-height:1.666em;--font-size-body:var(--font-size-user, var(--font-size));--line-height-body:var(--line-height-user, var(--line-height));--font-ui:var(--font-body);--font-size-ui:calc(var(--font-size) * 13 / 15);--line-height-ui:1.5em;--font-code:Consolas,Monaco,'Roboto Mono',monospace;--font-size-code:calc(var(--font-size) * 12 / 15);--line-height-code:1.333em;--font-size-table:calc(var(--font-size) * 12 / 15);--margin-paragraph:1rem;--margin-paragraph-body:1rem;--margin-block:1.25rem;--margin-ui:2.5ch;--border-radius:.333rem;--body-width:var(--body-width-user, 100%);--menu-width:var(--menu-width-user, 10rem);--color-border:rgba(0,0,0,.5);--color-border-section:var(--color-border);--color-border-header:var(--color-border);--color-border-footer:var(--color-border);--color-added:rgba(0,0,0,.5);--color-removed:#ccc;--color-search:rgba(0,0,0,.5)}article,blockquote,body,code,dd,div,dl,dt,fieldset,footer,form,h1,h2,h3,h4,h5,h6,header,input,legend,li,main,nav,ol,p,pre,section,td,textarea,th,ul{margin:0;padding:0}fieldset,img{border:0}address,caption,cite,code,dfn,em,strong,th,var{font-style:normal;font-weight:400}ol,ul{list-style:none}q:after,q:before{content:''}abbr,acronym{border:0;font-variant:normal}input,select,textarea{font-family:inherit;font-weight:inherit;font-size:100%}#yui3-css-stamp.cssreset,._Skin_MenuButton_,span.topicpath-top,tbody:empty,thead:empty{display:none}a,button,iframe,input[type=button i],input[type=reset i],input[type=submit i]{vertical-align:bottom}html{background:#fff;font-family:var(--font-body);font-size:var(--font-size);background-color:var(--color-bg);color:var(--color);-webkit-touch-callout:none;-webkit-text-size-adjust:100%}body,html{width:auto;max-width:100%;min-width:0;min-height:100vh;margin:0;padding:0}*{position:relative;box-sizing:border-box}article,aside,code,dd,details,dialog,div,dl,dt,fieldset,form,hgroup,hr,nav,p,pre{position:relative;margin-top:var(--margin-block);margin-bottom:var(--margin-block);flex:0 100 auto}#body h1:first-child,#body h2:first-child,#body h3:first-child,#body h4:first-child,#body h5:first-child,#body h6:first-child,#body>:first-child,dd,h1:first-child,h2:first-child,h3:first-child,h4:first-child,h5:first-child,h6:first-child,hr+h1,hr+h2,hr+h3,hr+h4,hr+h5,hr+h6{margin-top:0}#body{flex:0 100000 100%;font-size:var(--font-size-body);line-height:var(--line-height-body);margin:0;z-index:0}#_Skin_SkipLink_,a._Skin_SkipLink_{z-index:1;position:absolute;margin:0}p{margin-top:var(--margin-paragraph);margin-bottom:var(--margin-paragraph)}main p{margin-block-start:var(--margin-paragraph-body);margin-block-end:var(--margin-paragraph-body);margin-inline-start:0;margin-inline-end:0}a{color:var(--color-link)}a:hover{text-decoration-line:underline;text-decoration-style:solid;text-decoration-color:var(--color-link)}a:visited{color:var(--color-link-visited)}#footer,#menubar,#rightbar{position:relative;font-family:var(--font-ui);font-size:var(--font-size-ui);line-height:var(--line-height-ui)}#menubar,#navigator,#rightbar,.anchor_super,.jumpmenu,.note_hr,button{user-select:none;-moz-user-select:none;-webkit-user-select:none;-ms-user-select:none}code,pre{font-family:var(--font-code);font-feature-settings:'fwid' 1,'tnum' 1,'zero' 1,'lnum' 1;font-size:var(--font-size-code);line-height:var(--line-height-code);white-space:pre-wrap;line-break:anywhere;tab-size:4;-moz-tab-size:4}#attach,#footer,#header,#lastmodified,#related,h1,h2,h3,h4,h5,h6{font-family:var(--font-headline)}pre{background-color:var(--color-bg-code);color:var(--color-code);position:relative;max-width:100%;border:1px solid var(--color-border);border-radius:var(--border-radius);padding:.5em .75em;margin:var(--margin-block) 0}main pre{margin:var(--margin-paragraph-body) 0}img{border:none}.note_super,sup{vertical-align:super}embed,iframe,img,object,video{max-width:100%;height:auto}.edit_form,.spacer,iframe{clear:both}body{flex-flow:column nowrap;align-items:stretch;justify-content:flex-start;align-content:flex-start}#footer>*,body>div,body>p,table[summary='calendar frame'] .style_calendar{margin:0}.anchor_super,.jumpmenu{position:absolute;visibility:hidden;vertical-align:super;font-size:var(--font-size-ui);font-weight:400;line-height:1em;width:0;max-width:0;height:0;max-height:0;margin:0;padding:0;border:none;letter-spacing:0;text-indent:0;box-shadow:none}.contents,svg,table{width:auto}.anchor_super,.anchor_super:visited,.jumpmenu,.jumpmenu:visited{text-decoration:none;color:var(--color-border)}:hover>.anchor_super{visibility:visible;position:absolute;min-height:0;min-width:0;margin:0;padding:0;border:none}sub{vertical-align:sub}#contents{flex-flow:row nowrap;align-items:stretch;justify-content:var(--justify-content,center);align-content:space-between;flex-grow:10000;max-width:100%;margin:0 var(--margin-ui);padding:0}#_Skin_Article_{order:var(--order-article,2);flex:10000 1 auto;display:flex;flex-flow:column nowrap;align-items:stretch;justify-content:center;align-content:stretch;margin:0 auto;max-width:var(--body-width,100%);padding:0}#_Skin_Copyright_,#navigator,#navigator>a,#navigator>span,#note .note_super,.contents{display:inline-block}#navigator{clear:both;float:right;text-align:right}#navigator>span{margin:0 .3em;color:var(--color-border-section)}#_Skin_Copyright_{float:left;text-align:left}#menubar,#rightbar{position:relative;top:0;left:0;color:var(--color-menu);background-color:var(--color-bg-menu);width:var(--menu-width);min-width:var(--menu-width);max-width:var(--menu-width);margin:0}#menubar{order:var(--order-menubar,1);flex:0 1 var(--menu-width)}#rightbar{order:var(--order-rightbar,3);flex:0 1 var(--menu-width)}#menubar li,#rightbar li{display:block;margin-top:.3em;margin-bottom:.7em;line-height:1.1em}#menubar ul>li,#rightbar ul>li{list-style-type:none}#menubar.spacer,#rightbar.spacer{min-width:0;max-width:calc(var(--menu-width) + var(--margin-ui));flex-basis:calc(100vw - var(--menu-width) - var(--body-width) - var(--margin-ui) * 4)}#header{flex-flow:row nowrap;line-height:1.1em;max-width:100%;border-bottom:3px double var(--color-border-header);padding:1em var(--margin-ui);margin:0 0 calc(var(--margin-block) * 1.5)}#header>*{margin:0;flex-flow:column nowrap;align-items:stretch;justify-content:center;align-content:center;flex:0 1 auto}#logo,#page_title,dd{display:block}#header>:nth-child(2){margin:0 .25em;flex:1 1 auto}#logo{max-height:3rem;width:3rem;min-width:3rem;max-width:3rem;margin-right:.5rem;padding:0;fill:var(--color-logo);stroke:var(--color-logo)}#page_title{font-size:118%;font-weight:700;line-height:1.15em;margin:0 0 .625em;padding:0}#topic-path{font-size:88%;font-weight:700;margin:0;user-select:auto;-moz-user-select:auto;-webkit-user-select:auto;-ms-user-select:auto}#note{clear:both;margin:var(--margin-block) 0 auto;font-size:90%}.note_super{font-size:80%}#footer,#note .note_super,.__plugin_new,.style_calendar td,.style_calendar th,a._Skin_SkipLink_,h1,h2,h3,h4,h5,h6,li,ol,table,tbody,td,th,thead,ul{vertical-align:middle}#note .note_super{font-size:100%;margin-right:.333em}#attach,#lastmodified,#related{clear:both;flex-grow:1;font-size:80%;margin:2em 0 0}#footer{margin:var(--margin-block) 0 0;padding:1em var(--margin-ui) 1em;flex-flow:column nowrap;background:var(--color-bg-footer);border-top:1px double var(--color-border-footer)}#footer>*>*{margin:.5em 0}h1,h2,h3,h4,h5,h6,hr,table{padding:0;clear:both}h1,h2,h3,h4,h5,h6{position:relative;color:var(--color-headline);margin:calc(var(--margin-block) * 2) 0 calc(var(--margin-block) * .5);padding:0;font-weight:700;background-color:var(--color-bg-headline);border:0 solid transparent;line-height:var(--line-height-ui)}h1{font-size:201.1357188%}h2{font-size:174.900625%}h3{font-size:152.0875%}h4{font-size:132.25%}h5{font-size:115%}#menubar h6,#rightbar h6,h6{font-size:100%}#menubar h1,#rightbar h1{font-size:161%}#menubar h2,#rightbar h2{font-size:146%}#menubar h3,#rightbar h3{font-size:133%}#menubar h4,#rightbar h4{font-size:121%}#menubar h5,#rightbar h5{font-size:110%}#body h1,#body h2,#body h3{margin-top:calc(var(--margin-block) * 2.5)}#body h3{padding-left:.5em;border-left:var(--border-headline,.4em solid var(--color))}b,strong{font-weight:700;font-style:inherit}em{font-weight:inherit;font-style:italic}.__plugin_new,.style_th,th,thead td{font-weight:700;text-align:center}table,tbody,td,th,thead{width:auto;border:1px solid var(--color-border);border-collapse:collapse;-webkit-background-clip:padding-box;background-clip:padding-box;-webkit-border-horizontal-spacing:0;-webkit-border-vertical-spacing:0}table{max-width:initial;font-size:var(--font-size-table);padding:0;color:inherit}td,th{padding:.5em;margin:0}li,ol,ul{text-indent:0;list-style-position:inside}main ol,main ul{margin-top:var(--margin-paragraph);margin-bottom:var(--margin-paragraph-body)}main li ol,main li ul{margin-top:0;margin-bottom:0}li{margin-top:.25em;margin-bottom:.25em}ul>li{list-style-type:disc}.contents ul>li,ol>li{list-style-type:decimal}.contents ul>li>ul>li,ol>li>ol>li,ul>li>ol>li{list-style-type:lower-roman}.contents ul>li>ul>li>ul>li,ol>li>ol>li>ol>li,ol>li>ul>li>ol>li,ul>li>ol>li>ol>li,ul>li>ul>li>ol>li{list-style-type:lower-alpha}li>ol,li>ul{margin-left:1.5em}input[type=date],input[type=datetime-local],input[type=datetime],input[type=email],input[type=month],input[type=number],input[type=password],input[type=range],input[type=search],input[type=tel],input[type=text],input[type=time],input[type=url],input[type=week],select,textarea{position:relative;max-width:100%;padding:.25em .5em;border:1px solid var(--color-border);color:var(--color-input);background-color:var(--color-bg-input);white-space:pre-wrap}button,input[type=button],input[type=file],input[type=reset],input[type=submit]{font-family:var(--font-ui);font-size:var(--font-size-ui);user-select:none;-moz-user-select:none;-webkit-user-select:none;-ms-user-select:none;vertical-align:middle;line-height:1em;min-width:5em;min-height:1.5rem;cursor:pointer}button,input[type=button],input[type=reset],input[type=submit]{padding:.5em 1em;border:var(--color-border);border-radius:var(--border-radius);color:var(--color-bg);background-color:var(--color)}button:focus,input[type=button]:focus,input[type=reset]:focus,input[type=submit]:focus{background-color:var(--color-link)}input[type=file]{margin-top:.666em;margin-bottom:.666em}button:disabled,input[type=button]:disabled,input[type=file]:disabled,input[type=reset]:disabled,input[type=submit]:disabled{opacity:.5;cursor:auto}hr{border-width:1px 0 0;border-style:solid;border-color:var(--color-border)}.contents{font-size:88%;border:1px dashed var(--color-border);padding:0 1em}.contents,.contents ol,.contents ul{line-height:1.25em}.attention,.attention a,.attention a:visited{color:var(--color-attention)}strong.word0,strong.word1,strong.word2,strong.word3,strong.word4,strong.word5,strong.word6,strong.word7,strong.word8,strong.word9{color:var(--color-search);background-color:var(--color-bg-search)}dt{margin-bottom:0}dd{margin-inline-start:2em}blockquote{margin-left:2em;font-size:97.5%}dialog{border:0;background:0 0}dialog::backdrop{opacity:.5;background:#fff}#_Skin_SkipLink_{top:.5rem;left:.5rem;min-width:15em;padding:0;line-height:0;outline:0}a._Skin_SkipLink_{left:0;top:-100rem;font-size:.9rem;font-weight:600;padding:0 .75em;line-height:2em;height:2em;color:var(--color-bg);background:var(--color-link);border-radius:var(--border-radius)}.__plugin_new,div.counter,span.counter{font-size:70%}a._Skin_SkipLink_:focus{top:0}.clear{margin:0;clear:both}.diff_added{color:var(--color-added);background-color:var(--color-bg-added)}.diff_removed{color:var(--color-removed);background-color:var(--color-bg-removed)}form>div{z-index:1}div.img_margin{margin-right:1em}span.topicpath-slash{margin:0 .0333em;color:var(--color)}tr.bugtrack_list_header th{background-color:#ffc}tr.bugtrack_state_proposal td{background-color:#ccf}tr.bugtrack_state_accept td{background-color:#fc9}tr.bugrack_state_resolved td{background-color:#cfc}tr.bugtrack_state_pending td{background-color:#fcf}tr.bugtrack_state_cancel td{background-color:#ccc}tr.bugtrack_state_undef td{background-color:#f33}.search-result-page-summary{font-size:70%;color:gray;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.style_calendar td,.style_calendar th{padding:.125rem .0625rem;text-align:center;white-space:nowrap}.style_td_caltop{white-space:pre-wrap}.__plugin_new{line-height:1em;white-space:nowrap}#footer div#_p_recaptcha3_terms{font-size:.4375rem}@media print{a{text-decoration:none}#PluginTabs,#_Skin_ModalScreen_,#_p_recaptcha3_terms,#attach,#menubar,#navigator,#related,#rightbar,#toolbar,.anchor_super,.jumpmenu{display:none}}@media (max-width:767px){:root{--margin-ui:.5rem;--mode-width:1}#contents{flex-direction:column}#_Skin_Article_{order:1}#menubar,#rightbar{font-size:var(--font-size);line-height:var(--line-height);margin:var(--margin-ui) auto 0;padding:var(--margin-ui);border:1px solid var(--color-border-section);min-width:100%;max-width:100%;border-radius:var(--border-radius);order:2;flex:1 1 auto}#rightbar{order:3}@media screen{#_Skin_ModalScreen_{position:absolute;left:0;top:0;min-width:100%;min-height:100%;max-height:initial;height:auto;margin:0;padding:0 var(--margin-ui);overflow:auto;z-index:1999999990;pointer-events:auto;visibility:visible;flex-flow:column nowrap;align-items:stretch;justify-content:flex-start;align-content:flex-start;background:0 0}#_Skin_ModalScreen_ #menubar{max-height:initial;height:auto;margin:var(--margin-ui) auto;order:1;overflow:hidden}._Skin_MenuButton_{position:absolute;top:.375rem;right:.375rem;display:block;z-index:1;width:2.25rem;min-width:2.25rem;max-width:2.25rem;height:2.25rem;min-height:2.25rem;max-height:2.25rem;font-size:0;line-height:0;color:var(--color);background-color:var(--color-bg);border:1px solid var(--color-border-section);border-radius:var(--border-radius);text-align:center;vertical-align:middle;font-weight:700;margin:0;padding:0;fill:var(--color);stroke-width:0;cursor:pointer}#_Skin_MenuOpenButton_{position:relative;top:0;left:0}}#menubar{pointer-events:auto}#body{max-width:calc(100vw - var(--margin-ui) * 2);overflow:hidden;font-size:calc(var(--font-size-body) * .96);display:flex;flex-direction:column;flex:0 100000 100%}td input[type=date],td input[type=datetime-local],td input[type=datetime],td input[type=email],td input[type=file],td input[type=month],td input[type=number],td input[type=password],td input[type=range],td input[type=search],td input[type=tel],td input[type=text],td input[type=time],td input[type=url],td input[type=week],td textarea{width:auto;max-width:75vw}div>textarea{width:auto;max-width:100%}#menubar.spacer,#rightbar.spacer{display:none}}html._ikaskin_simplify_ #body h1,html._ikaskin_simplify_ #body h2,html._ikaskin_simplify_ #body h3,html._ikaskin_simplify_ #body h4,html._ikaskin_simplify_ #body h5,html._ikaskin_simplify_ #body h6{border:none;padding:0}html._ikaskin_wordwrap_ main h1,html._ikaskin_wordwrap_ main h2,html._ikaskin_wordwrap_ main h3,html._ikaskin_wordwrap_ main h4,html._ikaskin_wordwrap_ main h5,html._ikaskin_wordwrap_ main h6,html._ikaskin_wordwrap_ main li,html._ikaskin_wordwrap_ main p{word-break:normal;overflow-wrap:normal;word-wrap:normal;line-break:strict}html._ikaskin_wordbreak_ main h1,html._ikaskin_wordbreak_ main h2,html._ikaskin_wordbreak_ main h3,html._ikaskin_wordbreak_ main h4,html._ikaskin_wordbreak_ main h5,html._ikaskin_wordbreak_ main h6,html._ikaskin_wordbreak_ main li,html._ikaskin_wordbreak_ main p{word-break:break-all;overflow-wrap:break-word;word-wrap:break-word;line-break:loose}@media screen{:root{--color-bg:var(--color-bg-user, #fff);--color:rgba(0,0,0,.95);--color-headline:var(--color);--color-bg-headline:var(--color-bg);--color-menu:var(--color);--color-bg-menu:var(--color-bg);--color-link:var(--color-link-user, rgb(0,96,112));--color-link-underline:var(--color-link-user, rgba(0,96,112,.3));--color-link-visited:var(--color-link);--color-logo:var(--color);--color-border:rgba(0,0,0,.333);--color-input:var(--color);--color-bg-input:#fff;--color-code:rgba(0,0,0,.8);--color-bg-code:rgba(128,128,128,.06);--color-bg-table:rgba(128,128,128,.06);--color-attention:#e70473;--color-added:#e70473;--color-bg-added:transparent;--color-removed:#00c1c1;--color-bg-removed:transparent;--color-search:var(--color-attention);--color-bg-search:transparent;--color-border-section:rgba(0,0,0,.5);--color-border-header:var(--color-border-section);--color-border-footer:var(--color-border-section);--color-bg-footer:transparent;--dcolor-bg:var(--dcolor-bg-user, #222);--dcolor:rgba(240,240,240,.95);--dcolor-headline:var(--dcolor);--dcolor-bg-headline:var(--dcolor-bg);--dcolor-menu:var(--dcolor);--dcolor-bg-menu:var(--dcolor-bg);--dcolor-link:var(--dcolor-link-user, rgb(176,255,255));--dcolor-link-underline:var(--dcolor-link-user, rgba(176,255,255,.3));--dcolor-link-visited:var(--dcolor-link);--dcolor-logo:var(--dcolor);--dcolor-border:rgba(240,240,240,.333);--dcolor-input:var(--dcolor);--dcolor-bg-input:#000;--dcolor-code:rgba(240,240,240,.8);--dcolor-bg-code:rgba(128,128,128,.333);--dcolor-bg-table:rgba(128,128,128,.225);--dcolor-attention:#e70473;--dcolor-added:#e70473;--dcolor-bg-added:transparent;--dcolor-removed:#00c1c1;--dcolor-bg-removed:transparent;--dcolor-search:var(--dcolor-attention);--dcolor-bg-search:transparent;--dcolor-border-section:rgba(240,240,240,.5);--dcolor-border-header:var(--dcolor-border-section);--dcolor-border-footer:var(--dcolor-border-section);--dcolor-bg-footer:transparent}html._ikaskin_theme_dark_{--color-bg:var(--dcolor-bg);--color:var(--dcolor);--color-headline:var(--dcolor-headline);--color-bg-headline:var(--dcolor-bg-headline);--color-menu:var(--dcolor-menu);--color-bg-menu:var(--dcolor-bg-menu);--color-link:var(--dcolor-link);--color-link-underline:var(--dcolor-link-underline);--color-link-visited:var(--dcolor-link-visited);--color-logo:var(--dcolor-logo);--color-border:var(--dcolor-border);--color-input:var(--dcolor-input);--color-bg-input:var(--dcolor-bg-input);--color-code:var(--dcolor-code);--color-bg-code:var(--dcolor-bg-code);--color-bg-table:var(--dcolor-bg-table);--color-attention:var(--dcolor-attention);--color-added:var(--dcolor-added);--color-bg-added:var(--dcolor-bg-added);--color-removed:var(--dcolor-removed);--color-bg-removed:var(--dcolor-bg-removed);--color-search:var(--dcolor-search);--color-bg-search:var(--dcolor-bg-search);--color-border-section:var(--dcolor-border-section);--color-border-header:var(--dcolor-border-header);--color-border-footer:var(--dcolor-border-footer);--color-bg-footer:var(--dcolor-bg-footer)}}@media screen and (prefers-color-scheme:dark),screen and (light-level:dim),screen and (environment-blending:additive){:root{color-scheme:dark}html._ikaskin_theme_adaptive_{--color-bg:var(--dcolor-bg);--color:var(--dcolor);--color-headline:var(--dcolor-headline);--color-bg-headline:var(--dcolor-bg-headline);--color-menu:var(--dcolor-menu);--color-bg-menu:var(--dcolor-bg-menu);--color-link:var(--dcolor-link);--color-link-underline:var(--dcolor-link-underline);--color-link-visited:var(--dcolor-link-visited);--color-logo:var(--dcolor-logo);--color-border:var(--dcolor-border);--color-input:var(--dcolor-input);--color-bg-input:var(--dcolor-bg-input);--color-code:var(--dcolor-code);--color-bg-code:var(--dcolor-bg-code);--color-bg-table:var(--dcolor-bg-table);--color-attention:var(--dcolor-attention);--color-added:var(--dcolor-added);--color-bg-added:var(--dcolor-bg-added);--color-removed:var(--dcolor-removed);--color-bg-removed:var(--dcolor-bg-removed);--color-search:var(--dcolor-search);--color-bg-search:var(--dcolor-bg-search);--color-border-section:var(--dcolor-border-section);--color-border-header:var(--dcolor-border-header);--color-border-footer:var(--dcolor-border-footer);--color-bg-footer:var(--dcolor-bg-footer)}dialog::backdrop{background:#222}}@media screen and (forced-colors:active){:root{--color-bg:Canvas;--color:CanvasText;--color-headline:CanvasText;--color-bg-headline:Canvas;--color-menu:CanvasText;--color-bg-menu:Canvas;--color-link:LinkText;--color-link-underline:LinkText;--color-link-visited:VisitedText;--color-logo:CanvasText;--color-border:GrayText;--color-input:FieldText;--color-bg-input:Field;--color-code:CanvasText;--color-bg-code:Canvas;--color-bg-table:Canvas;--color-attention:MarkText;--color-added:MarkText;--color-bg-added:Mark;--color-removed:HighlightText;--color-bg-removed:Highlight;--color-search:MarkText;--color-bg-search:Mark;--color-border-section:GrayText;--color-border-header:GrayText;--color-border-footer:GrayText;--color-bg-footer:transparent}a._Skin_SkipLink_,button,button:focus,input[type=button],input[type=button]:focus,input[type=reset],input[type=reset]:focus,input[type=submit],input[type=submit]:focus{color:ButtonText;background:ButtonFace;border:outset buttonBorder}}</style>";
