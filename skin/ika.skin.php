...
if (!defined('IKASKIN_COPYRIGHT'))         define('IKASKIN_COPYRIGHT',         0); // Admin's name prefix (0:"Site admin", 1:"(C)")
...
if (!defined('IKASKIN_CSS'))               define('IKASKIN_CSS',              ''); // CSS file path (ex. 'mystyle.css')
...
<?php if (IKASKIN_CSS) echo '<link rel="stylesheet" type="text/css" href="' . SKIN_DIR . IKASKIN_CSS . "\" />\n"; ?>
...
?>
		...
		<?php
		if ($modifier) {
			$adminPrefix = (IKASKIN_COPYRIGHT)? '&copy; ' : 'Site admin: ';
