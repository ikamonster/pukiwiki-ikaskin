...
<?php if (IKASKIN_THEME == 2) { echo '<meta name="theme-color" media="(prefers-color-scheme:light)" content="#fff"/><meta name="theme-color" media="(prefers-color-scheme:dark)" content="#212121"/>'; } else { echo '<meta name="theme-color" content="' . (!IKASKIN_THEME ? '#fff' : '#212121') . '"/>'; } ?>
